...
start_marker = '<div className="flex justify-between items-center mb-6 border-b border-gray-800 pb-3">'
end_marker = '</form>\n                                      )}'
...
if idx1 != -1 and idx2 != -1:
    new_block = """<div className="flex justify-between items-center mb-6 border-b border-gray-800 pb-3">
    ...
    # Also remove setMaterialMode('update') from the table button
    content = content.replace("setMaterialMode('update'); ", "")
    content = content.replace("setMaterialMode('update');", "")

    # And append the modal to the very end of the file
    modal_code = """
...
"""
    ...
    with open(path, 'w', encoding='utf-8') as f:
        f.write(content)
    print('Clean pos replacement success')
else:
